...
# Step 3: Apply an artistic style to our composited image
#
# We now use the Neural Style Transfer algorithm to apply an artistic style
# from a set of source images (found in images/21styles/) to our live composited
# image.
#
# You can cycle through the different images in that folder using the "n" key
# on your keyboard with the window selected.
